                                    ...
                                    <table class="table mb-0">
                                        <thead class="bg-light">
                                            <tr>
                                                ...
                                                <th scope="col" class="border-0">Nama Suplier</th>
                                                <th scope="col" class="border-0">No Telp Suplier</th>
                                                <th scope="col" class="border-0">Alamat Suplier</th>
                                            ...
                                            <?php foreach ($supplier as $spl) : ?>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><?= $spl["no_telp_supplier"]; ?></td>
                                                        <td><?= $spl["alamat"]; ?></td>
                                                        <td>
                                                            <div class="d-grid gap-2 d-md-block">
                                                                <a data-bs-toggle="modal" data-bs-target="#ubahdata<?= $spl["id_supplier"]; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit suplier">
                                                                ...
                                                                <!-- Modal -->
                                                                <div class="modal fade" id="ubahdata<?= $spl['id_supplier']; ?>" tabindex="-1" aria-labelledby="ubahdata" aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                            ...
                                                                            <div class="modal-body" style="text-align: left;">
                                                                                ...
                                                                                <form action="" method="POST">
                                                                                    ...
                                                                                    <div class="mb-3">
                                                                                        <label for="nama_supplier" class="form-label">Nama Supplier</label>
                                                                                        <input type="text" class="form-control" id="nama_supplier" placeholder="masukkan nama" name="nama_supplier" value="<?= $spl["nama_supplier"]; ?>">
                                                                                    </div>
                                                                                    <div class="mb-3">
                                                                                        <label for="notelp_supplier" class="form-label">No.Telepon</label>
                                                                                        <input type="number" class="form-control" id="notelp_supplier" placeholder="masukkan nomor telepon" name="notelp_supplier" value="<?= $spl["no_telp_supplier"]; ?>">
                                                                                    </div>
                                                                                    <div class="mb-3">
                                                                                        <label for="alamat_supplier" class="form-label">Alamat Supplier</label>
                                                                                        <input type="text" class="form-control" id="alamat_supplier" placeholder="masukkan Alamat Supplier" name="alamat_supplier" value="<?= $spl["alamat"]; ?>">
                                                                                    </div>
                                                                ...
                                                                <!-- akhir modal -->
                                                                <a href="hapusSupplier.php?dels=<?= $spl["id_supplier"]; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="hapus">
