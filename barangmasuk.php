...
$barang = mysqli_query($conn, "SELECT * FROM barang_masuk join supplier on barang_masuk.id_supplier = supplier.id_supplier");
                            ...
                            <div class="card card-small mb-4">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="" method="POST">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="suplier" class="form-label">Nama Supplier </label>


                                                        <select class="form-control" name="suplier" id="suplier">
                                                            <option selected>Choose..</option>
                                                            <?php $suplier = mysqli_query($conn, "SELECT id_supplier, nama_supplier, no_telp_supplier FROM supplier"); ?>
                                                            <?php while ($spl = mysqli_fetch_array($suplier)) : ?>
                                                                <option value=<?= $spl["id_supplier"]; ?>><?= $spl["nama_supplier"]; ?> ( <?= $spl["no_telp_supplier"]; ?> ) </option>
                                                            <?php endwhile; ?>
                                                        </select>
                                ...
                                <div class="card-body p-0 pb-3 text-center">
                                    <table class="table mb-0">
                                        ...
                                        <?php $i = 1; ?>
                                        <?php while ($barangMasuk = mysqli_fetch_array($barang)) : ?>
                                            <tbody>
                                                <tr>
                                                    <td><?= $i; ?></td>
                                                    ...
                                                    <td>
                                                        <a data-bs-toggle="modal" data-bs-target="#ubahdata<?= $barangMasuk["id_barang_masuk"]; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit suplier">
                                                            <div class="d-grid gap-2 d-md-block">
                                                                <button class="btn btn-warning" type="button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-arrow-up" viewBox="0 0 16 16">
                                                                        <path d="M8.5 11.5a.5.5 0 0 1-1 0V7.707L6.354 8.854a.5.5 0 1 1-.708-.708l2-2a.5.5 0 0 1 .708 0l2 2a.5.5 0 0 1-.708.708L8.5 7.707V11.5z" />
                                                                        <path d="M14 14V4.5L9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2zM9.5 3A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h5.5v2z" />
                                                                    </svg></button>
                                                        </a>
                                                        <!-- Modal -->
                                                        <div class="modal fade" id="ubahdata<?= $barangMasuk['id_barang_masuk']; ?>" tabindex="-1" aria-labelledby="ubahdata" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                    ...
                                                                    <div class="modal-body" style="text-align: left;">
                                                                        ...
                                                                        <form action="" method="POST">
                                                                            ...
                                                                            <input type="hidden" name="idbarangmasuk" value="<?= $barangMasuk["id_barang_masuk"]; ?>">
                                                                            <div class="mb-3">
                                                                                <label for="nama_supplier" class="form-label">Supplier</label>
                                                                                <input type="text" class="form-control" id="nama_supplier" placeholder="masukkan nama" name="nama_supplier" value="<?= $barangMasuk["nama_supplier"]; ?>" disabled>
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <label for="namabarang" class="form-label">Nama Barang</label>
                                                                                <input type="text" class="form-control" id="namabarang" name="namabarang" value="<?= $barangMasuk["nama_barang"]; ?>">
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <label for="stok" class="form-label">Stok Barang</label>
                                                                                <input type="number" class="form-control" id="stok" name="stok" value="<?= $barangMasuk["stok"]; ?>">
                                                                            </div>
                                                                            <div class="mb-3">
                                                                                <label for="tanggal" class="form-label">tanggal</label>
                                                                                <input type="date" class="form-control" id="tanggal" name="tanggal" value="<?= $barangMasuk["tanggal"]; ?>">
                                                                            </div>
                                                                    ...
                                                                    <div class="modal-footer" name="ubahadata">
                                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                                                        ...
                                                        <!-- akhir modal -->
                                                        <a href="hapusBarangMasuk.php?delbrg=<?= $barangMasuk["id_barang_masuk"]; ?>">
