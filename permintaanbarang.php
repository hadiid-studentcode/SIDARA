...
$orders = mysqli_query($conn, "SELECT * FROM orders join barang_masuk on orders.id_barang_masuk = barang_masuk.id_barang_masuk");
                ...
                <div class="main-content-container container-fluid px-4">
                    ...
                    <div class="page-header row no-gutters py-4">
                        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                            ...
                            <h3 class="page-title">Order Barang</h3>
                        </div>
                    </div>
                    <!-- End Page Header -->
                    <!-- Default Light Table -->
                            ...
                            <div class="card card-small mb-4">
                                <div class="card-header border-bottom" data-bs-toggle="modal" data-bs-target="#tambahdata">
                                    <button type="button" class="btn btn-primary btn-lg"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-plus-circle-dotted" viewBox="0 0 16 16">
                                        ...
                                        </svg> Tambah Order Barang</button>
                                </div>
                                <!-- Modal -->
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Tambah Orders Barang</h5>
                                                ...
                                                <form action="" method="POST">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="barang" id="barang" class="form-control">
                                                            ...
                                                            <?php $barang = mysqli_query($conn, "SELECT id_barang_masuk,nama_barang,stok  FROM barang_masuk"); ?>
                                                            <?php while ($brg = mysqli_fetch_array($barang)) : ?>
                                                                <option value=<?= $brg["id_barang_masuk"]; ?>><?= $brg["nama_barang"]; ?> ( Stok : <?= $brg["stok"]; ?> ) </option>
                                                            <?php endwhile; ?>
                                                        </select>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="diajukan" class="form-label">Diajukan Oleh :</label>
                                                        <input type="text" class="form-control" id="diajukan" name="diajukan">
                                                    </div>
                                                    <div class="mb-3">
                                    ...
                                    <table class="table mb-0">
                                        <thead class="bg-light">
                                            <tr>
                                                ...
                                                <th scope="col" class="border-0">Diajukan Oleh</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-grid gap-2 d-md-block">
                                                            <a href="hapusOrder.php?delorder=<?= $order["id_order"]; ?>">
